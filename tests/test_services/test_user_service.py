...
# This test is creating a user with valid data
...
# This test is creating a user with invalid data
...
# This test is fetching data for a user by ID when the user exists
...
# This test is fetching for a user by nickname when the user exists
...
# This test is fetching data for a user by nickname when the user does not exist
...
# This test is fetching data for a user by email when the user exists
...
# This test is fetching data for a user by email when the user does not exist
...
# This test is updating a user with valid data
...
# This test is listing users with pagination
...
# This test is listing non professional users
...
# This test is to attempt a registeration for a user with valid data
...
# This test is to attempt a registertation for a user with invalid data
...
# This is testing a successful user login
...
# This is test the user loggin in with an incorrect email
...
# This is testing the user loggin in with an incorrect password
...
# This is testing the account to lock after maximum failed login attempts
...
# This is testing on resetting a user's password
...
# This is testing a verificaiton to the user's email
...
# This is testing to unlock a user's account
...
#This is testing the user professional status update
async def test_update_user_professional_status_valid(db_session, user, email_service):
    new_is_professional = True
    updated_user = await UserService.update_is_now_a_professional(db_session, user.id, new_is_professional, email_service)
    assert updated_user is not None
    assert updated_user.is_now_a_professional == new_is_professional
...
async def test_update_user_professional_status_invalid(db_session, user, email_service):
    new_is_professional = True
    updated_user = await UserService.update_is_now_a_professional(db_session, 1234, new_is_now_a_professional, email_service)
    assert updated_user is None
